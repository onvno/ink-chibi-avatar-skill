...
- `expression`: a short, reference-specific description of the eyes, brows, mouth, gaze, and head angle. Add one hand gesture only when it is essential; treat it as a small supporting cue, never the focal point.
...
- Treat hands as secondary to the face. Omit a hand unless it is necessary for the reference-specific expression or pose. If retained, show at most one simplified, softly painted partial hand at a lower or side edge, roughly no more than 15% of the canvas, with minimal finger detail. Keep it smaller than the face, out of the foreground, and clear of the eyes, mouth, and other key facial features.
