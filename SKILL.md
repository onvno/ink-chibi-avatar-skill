...
- Paint mostly with charcoal black, warm grey, and diluted ink washes. Use one optional muted accent colour—such as faded vermilion, ochre, indigo, or jade—only when it is supported by the reference. Do not use high-saturation colour blocks or glossy digital shading.
- Render facial skin as smooth, pale, opaque ink-wash colour planes. Do not show pores, paper grain, stippling, pencil scratches, dry-brush marks, random specks, blemishes, or noisy micro-texture on the face. Reserve wet and dry brush texture for hair, facial hair, clothing, and background.
...
Apply realism level [REALISM]: [REALISM DIRECTION]. Paint mostly with charcoal black, warm grey, and diluted ink washes. Use one optional muted accent colour only when supported by the reference. No high-saturation colour blocks, glossy digital shading, or photorealistic lighting.

Render facial skin as smooth, pale, opaque ink-wash colour planes. No pores, paper grain, stippling, pencil scratches, dry-brush marks, random specks, blemishes, or noisy micro-texture on the face. Place wet and dry brush texture in the hair, facial hair, clothing, and background instead.
