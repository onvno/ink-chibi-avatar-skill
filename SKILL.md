...
- Make a 1:1 square avatar. Use a close head-and-shoulders crop; the head occupies about 65–75% of the canvas height, with small shoulders or upper chest visible.
- Enlarge and slightly round the head, but avoid infant-like proportions and oversized glossy anime eyes.
...
- Keep outlines fine to medium and irregular. Use dark ink mainly for facial cues and small separations; let colour and value define most outer edges. Never use a thick, uniform black border around the head, body, clothing, or accessories.
...
| `0.66–0.80` | Default range: recognisable, mature hand-painted portrait; smooth skin with selective subtle texture and expression lines. |
...
| `style` | Direction |
| --- | --- |
| `watercolor-sketch` | Transparent washes, dry-brush texture, restrained pencil or ink marks; light and airy. |
...
Create a 1:1 square close head-and-shoulders composition. The head occupies about 65–75% of the image height, with small shoulders or upper chest visible. Make the head slightly oversized and rounded, but avoid baby proportions and huge glossy anime eyes.
...
Use fine-to-medium, irregular dark lines only for facial cues and small separations. Define most outer edges through paint value and colour. No thick, uniform black outlines or black contour bands.

Use a simple paper-texture or low-detail colour-field background. No scenery, text, letters, numerals, captions, signatures, logos, watermarks, UI, poster layout, borders, or frames.
