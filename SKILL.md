...
- Render facial skin as smooth, opaque ink-wash colour planes. By default, use a bright light-to-medium painted complexion with clear warm or cool undertones, soft luminous facial light, and lively cheek and lip colour when supported by the reference. Preserve recognisable undertone and colour character, but do not treat dim lighting, heavy cast shadows, or a photo's realistic skin darkness as the required base complexion. Use a deeper complexion only when the user explicitly asks to retain it. Do not show pores, paper grain, stippling, pencil scratches, dry-brush marks, random specks, blemishes, or noisy micro-texture on the face. Reserve wet and dry brush texture for hair, facial hair, clothing, and background.
...
Render facial skin as smooth, opaque ink-wash colour planes. By default, use a bright light-to-medium painted complexion with clear warm or cool undertones, soft luminous facial light, and lively cheek and lip colour when supported by the reference. Preserve recognisable undertone and colour character, but do not treat dim lighting, heavy cast shadows, or a photo's realistic skin darkness as the required base complexion. Use a deeper complexion only when the user explicitly asks to retain it. No pores, paper grain, stippling, pencil scratches, dry-brush marks, random specks, blemishes, or noisy micro-texture on the face. Place wet and dry brush texture in the hair, facial hair, clothing, and background instead.
